...
public class BubbleSort {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Hello welcome to Bubble Sort sample");
        System.out.println("Current files available: integers.txt\n");
        ...
        System.out.println("Integers picked and sorted numerically.");
        scanner.close();
    }
}
